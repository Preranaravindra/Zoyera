...
<html>
<head>
<title>zoyera | Completed Bookings</title>
...
if($ptype==1): echo "BASIC CLEANING (₹299)";endif;
if($ptype==2): echo "PREMIUM CLEANING (₹499)";endif;
if($ptype==3): echo "COMPLEX CLEANING (₹699)";endif;
