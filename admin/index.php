		...
		<div class="screen__content">
			...
			<h2 align="center">Admin Login</h2>
				<div class="login__field">	
					...
					<input type="text" class="name login__input" placeholder="User name" name="username" required="" >
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-lock"></i>
					<input type="password" class="login__input password" placeholder="Password" name="password" required="">
				</div>
			...
			<div class="back">
					<button class="backbtn"><h3><a href="../index.php">Back to home</a></h3></button>
				</div>
